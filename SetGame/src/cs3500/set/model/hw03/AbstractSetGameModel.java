...
public abstract class AbstractSetGameModel implements SetGameModel<Card> {
  ...
  /**
   * This method creates a board by assigning cards from the
   * given deck to each slot of the board.
   * @param deck deck that's going to be used in the game.
  ...
  /**
   * Creates a copy of a deck that's going to be actually used and modified in the game.
   * @param deck a list of cards that are going to be copied.
   * @return a copy of the given deck.
   */
  ...
  /**
   * Checks if there is less than 3 cards left in the deck.
   * @return true if there is less than 3 cards remaining in the deck,
   *         false otherwise.
   */
  ...
  /**
   * Checks if the given cards have different count attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have a different count attribute
  ...
  /**
   * Checks if the given cards have the same count attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have the same count attribute
   *         from one another, false otherwise.
   */
  ...
  /**
   * Checks if the given cards have different fillings attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have a different fillings attribute
   *         from one another, false otherwise.
   */
  ...
  /**
   * Checks if the given cards have the same fillings attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have the same fillings attribute
   *         from one another, false otherwise.
   */
  ...
  /**
   * Checks if the given cards have different shape attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have a different shape attribute
   *         from one another, false otherwise.
   */
  ...
  /**
   * Checks if the given cards have the same shape attribute.
   * @param card1 the first card
   * @param card2 the second card
   * @param card3 the third card
   * @return true if they all have the same shape attribute
   *         from one another, false otherwise.
   */
